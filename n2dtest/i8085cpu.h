...
#define M_IN                                                                        \
	...
	cpustate->AF.b.h=io_read_byte(cpustate->WZ.d);

#define M_OUT                                                                       \
	cpustate->WZ.d=ARG(cpustate);                                                   \
	io_write_byte(cpustate->WZ.d,cpustate->AF.b.h)

/* stack */
#define M_PUSH(R) {                                                                 \
	program_write_byte(--cpustate->SP.w.l, cpustate->R.b.h); \
	program_write_byte(--cpustate->SP.w.l, cpustate->R.b.l); \
}

#define M_POP(R) {                                                                  \
	cpustate->R.b.l = program_read_byte(cpustate->SP.w.l++); \
	cpustate->R.b.h = program_read_byte(cpustate->SP.w.l++); \
}
